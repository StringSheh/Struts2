 ...
 * Generated at: 2017-10-31 09:27:35 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t//设置树的数据参数\r\n");
      out.write("\t\t\t\t\tdata: {\r\n");
      out.write("\t\t\t\t\t\t//simpleData: 设置简单json数据参数\r\n");
      out.write("\t\t\t\t\t\tsimpleData: {\r\n");
      out.write("\t\t\t\t\t\t\t//enable: 开启简单json\r\n");
      out.write("\t\t\t\t\t\t\tenable: true\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\tcallback:{\r\n");
      out.write("\t\t\t\t\t\t//点击事件\r\n");
      out.write("\t\t\t\t\t\tonClick:treeClick\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t};\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t//2.准备数据（数组）\r\n");
      out.write("\t\t\t\t/* var zNodes = [\r\n");
      out.write("\t\t\t\t     {treeId:1,name:\"基础数据模块\",open:true},\r\n");
      out.write("\t\t\t\t     {treeId:11,name:\"收派标准\",parentId:1,url:\"http://www.baidu.com\"},\r\n");
      out.write("\t\t\t\t     {treeId:12,name:\"快递员管理\",parentId:1,icon:\"js/ztree/css/zTreeStyle/img/diy/6.png\"},\r\n");
      out.write("\t\t\t\t     {treeId:2,name:\"系统管理\"},\r\n");
      out.write("\t\t\t\t     {treeId:21,name:\"用户管理\",parentId:2,pageUrl:\"http://www.baidu.com\"},\r\n");
      out.write("\t\t\t\t     {treeId:22,name:\"角色管理\",parentId:2},\r\n");
      out.write("\t\t\t\t]; */\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t//异步抓取\r\n");
      out.write("\t\t\t\t$.post(\"data/menu.json\",function(zNodes){\r\n");
      out.write("\t\t\t\t\t//3.初始化树\r\n");
      ...
      out.write("\t\t\ttreeId： 树元素的ul元素的id\r\n");
      out.write("\t\t\ttreeNode: 当前点击的树节点的对象\r\n");
      out.write("\t\t\t*/\r\n");
      out.write("\t\t\tfunction treeClick(event,treeId,treeNode){ \r\n");
      out.write("\t\t\t\t//alert(\"点击了树\")\r\n");
      out.write("\t\t\t\t//alert(treeId);\r\n");
      out.write("\t\t\t\t//alert(treeNode.treeId+\"-\"+treeNode.name+\"-\"+treeNode.parentId);\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t/* var url = treeNode.pageUrl;\r\n");
      out.write("\t\t\t\twindow.location.href=url; */\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tvar name = treeNode.name;\r\n");
      out.write("\t\t\t\t//获取节点pageUrl属性\r\n");
      out.write("\t\t\t\tvar url = treeNode.pageUrl;\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tif(url!=null){\r\n");
      out.write("\t\t\t\t\t//判断该面板是否已经存在\r\n");
      ...
      out.write("\t\t\t\t\t\t\t//content: 直接把内容写在面板上面,注意:可以写任何的html标签（包括iframe）\r\n");
      out.write("\t\t\t\t\t\t\t//href: 抓取url把内容写面板上面,注意：只会把url的body里面的内容加载进来\r\n");
      out.write("\t\t\t\t\t\t\tcontent:\"<iframe src='\"+url+\"' style='width:100%;height:100%' frameborder='0'></iframe>\",\r\n");
      out.write("\t\t\t\t\t\t\t//显示关闭按钮\r\n");
      ...
      out.write("\t\t\t\t\t<iframe src=\"message.jsp\" style=\"width:100%;height: 100%\" frameborder='0'></iframe>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
